...
class Level7_GameScene: SKScene, SKPhysicsContactDelegate  {
...
//    var locationsArray = [CGPoint]()
    ...
    func saveHighScore() {
       // UserDefaults.standard.set(self.gameScore, forKey: "HIGHSCORE")
        UserDefaults.standard.set(self.gameScore, forKey: "HIGHSCORE7")
    }
    ...
    override func didMove(to view: SKView) {
        ...
        UserDefaults.standard.set(7, forKey: "currlevel")
...
//        highscoreLabel.zPosition = 100
        ...
        var tot_arr = [CGPoint]()
        var loc_arr = randomLocations(num: 28, tot_arr: tot_arr)
        tot_arr = loc_arr
        for i in 1...28{
            spawnCleanUp(location: loc_arr[i-1])
        }
        loc_arr = randomLocations(num: 19, tot_arr: tot_arr)
        //17
        for i in 1...19{
        ...
        let background = SKSpriteNode(imageNamed: "bedroom3")
...
//                UserDefaults.standard.set(true, forKey: "level6")
                UserDefaults.standard.set(true, forKey: "level8")
                self.gameScore += self.TimerNode
                scoreLabel.text = "SCORE:\(gameScore)"
                //self.TimerLabel.text = "Seconds Remaining: \(time)"
                if self.gameScore > UserDefaults().integer(forKey: "HIGHSCORE7") {
                            saveHighScore()
                    print("New high score!!!")
                    highscoreLabel.text = "High Score: \(UserDefaults().integer(forKey: "HIGHSCORE7")) "
                        }
