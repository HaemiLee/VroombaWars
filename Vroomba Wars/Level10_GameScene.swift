...
class Level10_GameScene: SKScene, SKPhysicsContactDelegate  {
...
//    var locationsArray = [CGPoint]()
    ...
    func saveHighScore() {
       // UserDefaults.standard.set(self.gameScore, forKey: "HIGHSCORE")
        UserDefaults.standard.set(self.gameScore, forKey: "HIGHSCORE10")
    }
    ...
    override func didMove(to view: SKView) {
        ...
        UserDefaults.standard.set(10, forKey: "currlevel")
...
//        highscoreLabel.zPosition = 100
        ...
        var tot_arr = [CGPoint]()
        var loc_arr = randomLocations(num: 35, tot_arr: tot_arr)
        tot_arr = loc_arr
        for i in 1...35{
            spawnCleanUp(location: loc_arr[i-1])
        }
        loc_arr = randomLocations(num: 25, tot_arr: tot_arr)
        //17
        for i in 1...25{
        ...
        let background = SKSpriteNode(imageNamed: "livingroom2")
...
//                UserDefaults.standard.set(true, forKey: "level6")
                ...
                if self.gameScore > UserDefaults().integer(forKey: "HIGHSCORE10") {
                            saveHighScore()
                    print("New high score!!!")
                    highscoreLabel.text = "High Score: \(UserDefaults().integer(forKey: "HIGHSCORE10")) "
                        }
                MusicPlayer.shared.stopBackgroundMusic()
                self.gameOver = true
                let sceneToMoveTo = MoreLevelsComingSoonScene(size: self.size)
