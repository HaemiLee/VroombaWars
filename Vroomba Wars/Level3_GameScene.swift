...
class Level3_GameScene: SKScene, SKPhysicsContactDelegate  {
...
//    var locationsArray = [CGPoint]()
    ...
    func saveHighScore() {
       // UserDefaults.standard.set(self.gameScore, forKey: "HIGHSCORE")
        UserDefaults.standard.set(self.gameScore, forKey: "HIGHSCORE3")
    }
    ...
    override func didMove(to view: SKView) {
        ...
        UserDefaults.standard.set(3, forKey: "currlevel")
...
//        highscoreLabel.text = "High Score: \(UserDefaults().integer(forKey: "HIGHSCORE3")) "
...
//        highscoreLabel.zPosition = 100
        ...
        loc_arr = randomLocations(num: 12, tot_arr: tot_arr)
        //12
        for i in 1...12{
        ...
        let background = SKSpriteNode(imageNamed: "kitchenBackground")
...
//              print("CHARGING...", health)
            ...
            if (clean == 0 && timer == true){
                UserDefaults.standard.set(true, forKey: "level4")
                self.gameScore += self.TimerNode
                scoreLabel.text = "SCORE:\(gameScore)"
                //self.TimerLabel.text = "Seconds Remaining: \(time)"
                if self.gameScore > UserDefaults().integer(forKey: "HIGHSCORE3") {
                            saveHighScore()
