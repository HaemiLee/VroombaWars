...
class Level9_GameScene: SKScene, SKPhysicsContactDelegate  {
...
//    var locationsArray = [CGPoint]()
    ...
    func saveHighScore() {
       // UserDefaults.standard.set(self.gameScore, forKey: "HIGHSCORE")
        UserDefaults.standard.set(self.gameScore, forKey: "HIGHSCORE9")
    }
    ...
    override func didMove(to view: SKView) {
        ...
        UserDefaults.standard.set(9, forKey: "currlevel")
...
//        highscoreLabel.zPosition = 100
        ...
        var tot_arr = [CGPoint]()
        var loc_arr = randomLocations(num: 32, tot_arr: tot_arr)
        tot_arr = loc_arr
        for i in 1...32{
            spawnCleanUp(location: loc_arr[i-1])
        }
        loc_arr = randomLocations(num: 22, tot_arr: tot_arr)
        //17
        for i in 1...22{
        ...
        let background = SKSpriteNode(imageNamed: "SunRoom2")
...
//                UserDefaults.standard.set(true, forKey: "level6")
                UserDefaults.standard.set(true, forKey: "level10")
                self.gameScore += self.TimerNode
                scoreLabel.text = "SCORE:\(gameScore)"
                //self.TimerLabel.text = "Seconds Remaining: \(time)"
                if self.gameScore > UserDefaults().integer(forKey: "HIGHSCORE9") {
                            saveHighScore()
                    print("New high score!!!")
                    highscoreLabel.text = "High Score: \(UserDefaults().integer(forKey: "HIGHSCORE9")) "
                        }
