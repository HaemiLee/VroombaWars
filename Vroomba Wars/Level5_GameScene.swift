//
//  Level5_GameScene.swift
//  Vroomba Wars
//
//  Created by Haemi Lee on 4/7/21.
//
...
class Level5_GameScene: SKScene, SKPhysicsContactDelegate  {
...
//    var locationsArray = [CGPoint]()
    ...
    func saveHighScore() {
       // UserDefaults.standard.set(self.gameScore, forKey: "HIGHSCORE")
        UserDefaults.standard.set(self.gameScore, forKey: "HIGHSCORE5")
    }
    ...
    override func didMove(to view: SKView) {
        ...
        UserDefaults.standard.set(5, forKey: "currlevel")
...
//        highscoreLabel.zPosition = 100
        ...
        var tot_arr = [CGPoint]()
        var loc_arr = randomLocations(num: 22, tot_arr: tot_arr)
        tot_arr = loc_arr
        for i in 1...22{
            spawnCleanUp(location: loc_arr[i-1])
        }
        loc_arr = randomLocations(num: 17, tot_arr: tot_arr)
        //17
        for i in 1...17{
        ...
        let background = SKSpriteNode(imageNamed: "BedroomBackground")
...
//                UserDefaults.standard.set(true, forKey: "level6")
                ...
                if self.gameScore > UserDefaults().integer(forKey: "HIGHSCORE5") {
                            saveHighScore()
