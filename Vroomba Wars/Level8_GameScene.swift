...
class Level8_GameScene: SKScene, SKPhysicsContactDelegate  {
...
//    var locationsArray = [CGPoint]()
    ...
    func saveHighScore() {
       // UserDefaults.standard.set(self.gameScore, forKey: "HIGHSCORE")
        UserDefaults.standard.set(self.gameScore, forKey: "HIGHSCORE8")
    }
    ...
    override func didMove(to view: SKView) {
        ...
        UserDefaults.standard.set(8, forKey: "currlevel")
...
//        highscoreLabel.zPosition = 100
        ...
        var tot_arr = [CGPoint]()
        var loc_arr = randomLocations(num: 30, tot_arr: tot_arr)
        tot_arr = loc_arr
        for i in 1...30{
            spawnCleanUp(location: loc_arr[i-1])
        }
        loc_arr = randomLocations(num: 20, tot_arr: tot_arr)
        //17
        for i in 1...20{
        ...
        let background = SKSpriteNode(imageNamed: "bathroom2")
...
//                UserDefaults.standard.set(true, forKey: "level6")
                UserDefaults.standard.set(true, forKey: "level9")
                self.gameScore += self.TimerNode
                scoreLabel.text = "SCORE:\(gameScore)"
                //self.TimerLabel.text = "Seconds Remaining: \(time)"
                if self.gameScore > UserDefaults().integer(forKey: "HIGHSCORE8") {
                            saveHighScore()
                    print("New high score!!!")
                    highscoreLabel.text = "High Score: \(UserDefaults().integer(forKey: "HIGHSCORE8")) "
                        }
